...
Although the logical structure stays identical the real "exam"ples, notationwise, work a bit differently. The notation I used cannot acurrately map all cases of the _Unterprogrammtechnik_, since it is an abstraction of how it's actually done. In actual Turing reductions, you would work with Turing machines and their corresponding Gödel numbers.
